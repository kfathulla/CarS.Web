      ...
      <div class="b-calendar__calendar">
        <div class="b-calendar__header">
          ...
          <div class="d-flex justify-content-between">
            <div class="text-left">
              <button class="arrow" @click="subtractMonth" data-bs-toggle="tooltip" :data-bs-title="previousMonthAsString">
            ...
            <div class="text-right">
              <button class="arrow arrow-right" @click="addMonth"
                data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="nextMonthAsString">
        ...
        <div class="b-calendar__dates">
          <div class="date text-right" :class="{
                            ...
                            'text-danger' : (date.key % 7 > 5 || date.key % 7 === 0) && !date.blank,
  ...
  export default {
    data() {
      return {
        ...
        plans: [{day: moment("08-07-2022", "MM-DD-YYYY"), title: "title", text: "cs suh si siuhs csdkchsdi cdcdcd i", link: "fdfd"},
                {day: moment("08-21-2022", "MM-DD-YYYY"), title: "title", text: "cs suh si siuhs csdkchsdi cdcdcd i", link: "fdfd"}]
      }
    },
    computed: {
        year() {
